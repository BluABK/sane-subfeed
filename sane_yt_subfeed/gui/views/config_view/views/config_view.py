...
class ConfigViewWidget(InputSuper):
    ...
    def add_config_tab_logging(self):
        ...
        self.add_option_info('26\t DB_INFO', None)
        self.add_option_info('20\t INFO', None)
        self.add_option_info('10\t DEBUG', None)
        self.add_option_info('9\t DEBUG2', None)
        self.add_option_info('8\t DEBUG3', None)
        self.add_option_info('7\t DEBUG4', None)
        self.add_option_info('6\t DEBUG5', None)
        self.add_option_info('5\t DEBUG6', None)
        self.add_option_info('4\t DB_DEBUG', None)
        self.add_option_info('3\t DEBUG8', None)
        self.add_option_info('2\t DEBUG9', None)
        self.add_option_info('1\t SPAMMY DEBUG', None)
